...
const MovieCard = ({ movie }) => {
  ...
  return (
    <div className="flex flex-col justify-baseline p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 transition duration-300 w-66">

      <img onClick={() => {navigate(`/movies/${movie._id}`);scrollTo(0, 0)}} src={movie.poster_path} alt="Movie image" className="rounded-lg h-52 w-full object-cover object-right-bottom cursor-pointer"/>
